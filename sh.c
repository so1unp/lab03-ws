...
void runcmd(struct cmd *cmd)
{
    ...
    switch (cmd->type) {
        ...
        case REDIR:
            ...
            // Cerrar el descriptor de archivo correspondiente (0 para entrada, 1 para salida)
            if (close(rcmd->fd) < 0) {
                perror("close failed");
                exit(1);
            }
            // Abrir el archivo con el modo especificado y asignarlo al descriptor de archivo cerrado
